...
include_once('../../controllers/conexao.php');
  ...
  $cod= $_SESSION['artId'];
  $sql= "SELECT * FROM oportunidade INNER JOIN contratante ON oportunidade.Contratante_conId = contratante.conId";
      ...
      <div class="right">
          ...
          <div class="projects">
            <div class="projects_data">
                <div class="data2">
                    <h4>Descrição</h4>
                    <p>Oportunidade criada por <?php echo $lin['conNome']?>.
                    <br/>
                    <?php echo $lin['opoDescricao']?>
        ...
        <div class="projects">
          ...
          <div class="social_media">
            <ul>
              <li>
                <a>
                  <form action="../../controllers/oportunidadesController.php?acao=candidatar" method="post">
                    <input type="hidden" value="<?php echo $lin['opoId']?>" name="opoId"></input>
                    <input type="hidden" value="<?php echo $_SESSION['artId']?>" name="artId"></input>
                    <button type="submit" value=""><i class="fas fa-check-square"></i>Candidatar</button>
                  </form>
                </a>
              </li>
            </ul>
