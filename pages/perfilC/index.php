...
<div >
        ...
        <div class="subheader ">
            ...
            <input type="hidden" value="<?php echo $linha['conId']?>" name="conId"></input>
            <a href="../updateC/index.php">
                <button type="submit" value="Gerar PDF">Editar Perfil</button> 
            </a>

            <a>
            <form action="../../controllers/contratanteController.php?acao=delete" method="post">
            <input type="hidden" value="<?php echo $linha['conId']?>" name="conId"></input>
            ...
            <div class="side-profile-bar text-center shadow rounded">
                <img class="rounded" src="<?php echo ("../../assets/imagensContratante/".$linha['conFoto']) ?>" width="240px">
                <h2><?php echo $linha['conNome'] ?></h2>
                <div class="line"></div>
                <p></p>
                ...
                <div class="pro-skill" id="skill">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo $linha['conDescricao'] ?></p><!-- p class="card-text" -->
                        </div> 
                    </div>
                </div> 
                <div class="card">
                            ...
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        ...
                                        <td scope="col"><?php echo $linha['conDoc'] ?></td>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr>
                                        <th scope="col">Gênero</th>
                                        <td scope="col"><?php echo $linha['conGenero'] ?></td>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr>
                                        <th scope="col">Endereço Completo</th>
                                        <td scope="col"><?php echo $linha['conEndereco'] ?>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td scope="col"><?php echo $linha['conEmail'] ?></td>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr>
                                        <th scope="col">Telefone</th>
                                        <td scope="col"><?php echo $linha['conTelefone'] ?></td>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr>
                                        <th scope="col">Categoria</th>
                                        <td scope="col"><?php echo $linha['conCategoria'] ?></td>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr>
                                        <th scope="col">Instagram</th>
                                        <td scope="col"><?php echo $linha['conInsta'] ?></td>
                                    </tr>
                                </thead>
